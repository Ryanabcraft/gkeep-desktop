#!/usr/bin/env python3
"""Google Keep Desktop — abre Google Keep no navegador em modo app."""
...
VERSION = "1.0.0"
REPO = "Ryanabcraft/gkeep-desktop"
...
def main():
    ...
    if update:
        ...
        resp = msgbox(
            ...
            f"Google Keep Desktop v{new_ver} disponível!\n\n"
    ...
    if not browser:
        ...
        msgbox("Google Keep Desktop", msg)
        sys.exit(1)
